...
namespace WPF_InventoryManagementSystem.MVVM.ViewModel {
    internal class CategoriesViewModel : INotifyPropertyChanged {
        ...
        private bool isCategoriesReadOnly = true;
        ...
        public bool IsCategoriesReadOnly {
            get { return isCategoriesReadOnly; }
            set {
                isCategoriesReadOnly = value;
                OnPropertyChanged(nameof(IsCategoriesReadOnly));
            }
        }
